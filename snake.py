...
pygame.mixer.music.load("Friendship.mp3") #в скобках пишем название нашей музыки, которую хотим запустить. Файл с музыкой и программой должны находиться в одном месте, иначе будет вылетать ошибка
